...

{
  ...
  "collections": \[ { "id", "name", "slug", "medias": \[...\], "sub\_collections": \[...\] } \],
...

{
  ...
  "treasury\_account\_id": null,

  "metadata": {},

  "configurations": { "publicKey": "pk\_live\_…" }
...

{
  ...
  "customer": { "id": "...", "first\_name": "Jean", "email": "[jean@example.com](mailto:jean@example.com)" }
...

{
  ...
  "active": true, "shop\_id": "\<ulid\>", "shop": { },

  "warehouses": \[ \], "warehouse\_ids": \["\<ulid\>"\], "metadata": {},
...

{
  ...
  "full\_address": "Rue 1.234, Douala, CM"
...
out\_of\_tax\_total  = subtotal \+ shipping − discount

total = net\_to\_pay = out\_of\_tax\_total \+ taxes\_positives \+ taxes\_negatives
...

{
  ...
  "products": \[
    ...
    { "product\_id": "\<product\_ulid\>", "variant\_id": "\<variant\_ulid\>", "quantity": 2, "price": 15000 }
  ...
  "shipping": {
    ...
    "scheduled\_at": "2026-05-22T10:00:00Z",

    "address\_id": "\<address\_ulid\>"

  },

  "shipping\_fee\_id": "\<shipping\_fee\_ulid\>",

  "discounts": \[

    { "discount\_id": "\<discount\_ulid\>", "code": "WELCOME10" }
...

{
  ...
  "customer": {
    ...
    "first\_name": "Jean", "last\_name": "Dupont",
  ...
  "products": \[
    ...
    { "product\_id": "\<product\_ulid\>", "variant\_id": "\<variant\_ulid\>", "quantity": 1, "price": 15000 }
  ...
  "shipping": {
    ...
    "address": {
      ...
      "first\_name": "Marie", "last\_name": "Kamga",
...
2. Mettez \*`"is_new": true`\*\* : sinon, pour un client connecté, le serveur réutilise une
...

{
  ...
  "data": {
    ...
    "billing": { "method": "cash", "status": "pending", "total": 32000, "net\_to\_pay": 32000, "address": { } },
  ...
  "payment\_link": "[https://checkout.stripe.com/](https://checkout.stripe.com/)..."
...

{
  ...
  "data": { "id": "\<order\_ulid\>", "reference": "CMD-000123" },

  "payment\_link": null,

  "token": "\<oauth\_access\_token\>",

  "customer": { "id": "\<customer\_ulid\>", "first\_name": "Jean", "email": "[jean@example.com](mailto:jean@example.com)" }
...
{ "amount\_due": 32000, "success\_url": "https://...", "cancel\_url": "https://..." }
...

{
  ...
  "id": "\<ulid\>", "tracking\_number": "TRK-00123", "tracking\_url": "[https://…](https://…)",

  "order\_id": "\<ulid\>", "status": "taken\_in\_charge", "mode": "default",

  "scheduled\_at": "…", "starts\_at": null, "ends\_at": null,

  "address": { },

  "products": \[ { "title": "…", "quantity": 2 } \],

  "delivery\_status": { "is\_complete": false, "is\_partial": true, "delivered\_quantity": 1, "sequence": 1, "is\_first": true },
...

{
  ...
  "delivery": { "id": "\<ulid\>", "status": "taken\_in\_charge", "order\_id": "\<ulid\>" },

  "position": { "latitude": 4.0511, "longitude": 9.7679, "accuracy": 10, "heading": 120, "speed": 5.5, "updated\_at": "…" }
