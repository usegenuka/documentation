...
<CodeGroup>
    ...
    const tokenResponse = await fetch("https://api.genuka.com/oauth/token", {
      method: "POST",
    ...
    ```php php
      $accessToken = "ACCESS_TOKEN_FROM_TOKEN_EXCHANGE";

      $ch = curl_init("https://api.genuka.com/orders");
    ...
    access_token = "ACCESS_TOKEN_FROM_TOKEN_EXCHANGE"
    headers = {"Authorization": f"Bearer {access_token}"}

    response = requests.get("https://api.genuka.com/orders", headers=headers)
